...
// test/preload.ts pins FLASHCODE_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.FLASHCODE_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.FLASHCODE_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.FLASHCODE_MODELS_PATH = undefined
  Flag.FLASHCODE_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.FLASHCODE_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.FLASHCODE_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
