...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const names = ["opencode.json", "opencode.jsonc", "flashcode.json", "flashcode.jsonc"]
    const directoryNames = [".flashcode", ".opencode"]
    ...
    // global config, project files, then `.opencode`/`.flashcode` files.
