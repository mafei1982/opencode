export const dict = {
  ...
  "dialog.provider.flashcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.flashcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.flashcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "FlashCodeが提供する無料モデル",
  ...
  "provider.connect.flashcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.flashcodeZen.visit.prefix": " ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "flashcode.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するFlashCodeサーバーを切り替えます。",
  ...
  "toast.update.description": "FlashCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをFlashCodeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (flashcode.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: FlashCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "FlashCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でFlashCodeサーバーを実行します。",
