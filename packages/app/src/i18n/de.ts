...
export const dict = {
  ...
  "dialog.provider.flashcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.flashcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.flashcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von FlashCode",
  ...
  "provider.connect.flashcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In flashcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den FlashCode-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von FlashCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem FlashCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (flashcode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: FlashCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "FlashCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "FlashCode-Server innerhalb von WSL unter Windows ausführen.",
