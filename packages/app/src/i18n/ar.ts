export const dict = {
  ...
  "dialog.provider.flashcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.flashcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.flashcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من FlashCode",
  ...
  "provider.connect.flashcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في flashcode.json",
  ...
  "dialog.server.description": "تبديل خادم FlashCode الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من FlashCode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق FlashCode",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (flashcode.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن FlashCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن FlashCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم FlashCode داخل WSL على Windows.",
