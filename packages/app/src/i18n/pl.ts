export const dict = {
  ...
  "dialog.provider.flashcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.flashcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.flashcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez FlashCode",
  ...
  "provider.connect.flashcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w flashcode.json",
  ...
  "dialog.server.description": "Przełącz serwer FlashCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja FlashCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu FlashCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (flashcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "FlashCode zawiera darmowe modele, więc możesz zacząć od razu.",
