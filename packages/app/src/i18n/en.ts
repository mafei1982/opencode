export const dict = {
  ...
  "dialog.provider.flashcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.flashcode.tagline": "Reliable optimized models",
  "dialog.provider.flashcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by FlashCode",
  ...
  "provider.connect.flashcodeZen.line1":
    "OpenCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.flashcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.flashcodeZen.visit.prefix": "Visit ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in flashcode.json",
  ...
  "wsl.onboarding.step.opencode": "FlashCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking FlashCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking FlashCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating FlashCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating FlashCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update FlashCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update FlashCode",
  "wsl.onboarding.opencodeReadyIn": "FlashCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "FlashCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install FlashCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install FlashCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "FlashCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before FlashCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "FlashCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen FlashCode.",
  ...
  "toast.update.description": "A new version of FlashCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the FlashCode team",
  ...
  "error.chain.checkConfig": "Check your config (flashcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, FlashCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "FlashCode includes free models so you can start immediately.",
