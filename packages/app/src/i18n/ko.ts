export const dict = {
  ...
  "dialog.provider.flashcode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.flashcode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.flashcodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "FlashCode에서 제공하는 무료 모델",
  ...
  "provider.connect.flashcodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.flashcodeZen.visit.prefix": "다음 ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "flashcode.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 FlashCode 서버를 전환합니다.",
  ...
  "toast.update.description": "FlashCode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 FlashCode 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(flashcode.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: FlashCode는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "FlashCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 FlashCode 서버를 실행합니다.",
