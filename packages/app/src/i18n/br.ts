export const dict = {
  ...
  "dialog.provider.flashcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.flashcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.flashcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo FlashCode",
  ...
  "provider.connect.flashcodeZen.visit.prefix": "Visite ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em flashcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor FlashCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do FlashCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do FlashCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (flashcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: FlashCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "FlashCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor FlashCode dentro do WSL no Windows.",
