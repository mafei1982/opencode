export const dict = {
  ...
  "dialog.provider.flashcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.flashcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.flashcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par FlashCode",
  ...
  "provider.connect.flashcodeZen.visit.prefix": "Visitez ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans flashcode.json",
  ...
  "dialog.server.description": "Changez le serveur FlashCode auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'FlashCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe FlashCode",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (flashcode.json) pour les noms de fournisseur/modèle",
  ...
  "sidebar.gettingStarted.line1":
    "FlashCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur FlashCode dans WSL sur Windows.",
