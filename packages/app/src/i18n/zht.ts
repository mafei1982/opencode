...
export const dict = {
  ...
  "dialog.provider.flashcode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.flashcode.tagline": "可靠的優化模型",
  "dialog.provider.flashcodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "FlashCode 提供的免費模型",
  ...
  "provider.connect.flashcodeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.flashcodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.flashcodeZen.visit.prefix": "造訪 ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 flashcode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 FlashCode 伺服器。",
  ...
  "toast.update.description": "FlashCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 FlashCode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (flashcode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: FlashCode 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "FlashCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 FlashCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 FlashCode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 FlashCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 FlashCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 FlashCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 FlashCode 啟動時自動檢查更新",
