...
export const dict = {
  ...
  "dialog.server.description": "切換此應用程式連線的 metaXtest 伺服器。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 metaXtest 伺服器。",
  ...
  "settings.general.row.language.description": "變更 metaXtest 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 metaXtest 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 metaXtest 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 metaXtest 的主題。",
  ...
  "settings.updates.row.startup.description": "在 metaXtest 啟動時自動檢查更新",
