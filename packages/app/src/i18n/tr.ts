...
export const dict = {
  ...
  "dialog.provider.flashcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.flashcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.flashcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "FlashCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.flashcodeZen.visit.prefix": "",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "dialog.plugins.empty": "Eklentiler flashcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi FlashCode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "FlashCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı FlashCode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (flashcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: FlashCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "FlashCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "FlashCode sunucusunu Windows'ta WSL içinde çalıştırın.",
