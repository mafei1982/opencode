...
export const dict = {
  ...
  "dialog.provider.flashcode.note": "使用 OpenCode Zen 或 API 密钥连接",
  "dialog.provider.flashcode.tagline": "可靠的优化模型",
  "dialog.provider.flashcodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "FlashCode 提供的免费模型",
  ...
  "provider.connect.flashcodeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.flashcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.flashcodeZen.visit.prefix": "访问 ",
  "provider.connect.flashcodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.flashcodeZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 flashcode.json 中配置的插件",
  ...
  "toast.update.description": "FlashCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 FlashCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (flashcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: FlashCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "FlashCode 提供免费模型，你可以立即开始使用。",
