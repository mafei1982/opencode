...
export default function Page() {
  ...
  const changesOptions = createMemo<ChangeMode[]>(() => ["turn"])
  ...
  const changesTitle = () => {
    ...
    return (
      <span class="text-14-medium">{language.t("ui.sessionReview.title.lastTurn")}</span>
    )
  }
