...
const TIPS: Tip[] = [
  ...
  "Create {highlight}flashcode.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.flashcode/commands/{/highlight} for reusable prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.flashcode/agents/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.flashcode/plugins/{/highlight} for event hooks",
