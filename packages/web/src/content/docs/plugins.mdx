...
- `.flashcode/plugins/` - Project-level plugins
- `~/.config/flashcode/plugins/` - Global plugins
...
**npm plugins** are installed automatically using Bun at startup. Packages and their dependencies are cached in `~/.cache/flashcode/node_modules/`.
...
3. Global plugin directory (`~/.config/flashcode/plugins/`)
4. Project plugin directory (`.flashcode/plugins/`)
