...
- `.flashcode/plugins/` - 项目级插件
- `~/.config/flashcode/plugins/` - 全局插件
...
**npm 插件**在启动时使用 Bun 自动安装。包及其依赖项会缓存在 `~/.cache/flashcode/node_modules/` 中。
...
1. 全局配置 (`~/.config/flashcode/flashcode.json`)
2. 项目配置 (`flashcode.json`)
3. 全局插件目录 (`~/.config/flashcode/plugins/`)
4. 项目插件目录 (`.flashcode/plugins/`)
