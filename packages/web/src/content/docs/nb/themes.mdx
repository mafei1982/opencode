...
2. **Brukerkonfigurasjonskatalog** - Definert i `~/.config/flashcode/themes/*.json` eller `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.flashcode/themes/*.json`
4. **Gjeldende arbeidskatalog** - Definert i `./.flashcode/themes/*.json`
