...
:::caution
Når du bruker `--hostname 0.0.0.0`, sett `FLASHCODE_SERVER_PASSWORD` for å sikre serveren.
...
- OpenCode-konfigurasjon og sesjoner lagres i WSL-miljøet på `~/.local/share/flashcode/`
