...
Dette er atskilt fra `flashcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `FLASHCODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
