...
- `.flashcode/plugins/` - Programtillegg på prosjektnivå
...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/flashcode/node_modules/`.
...
1. Global konfigurasjon (`~/.config/flashcode/flashcode.json`)
2. Prosjektkonfigurasjon (`flashcode.json`)
3. Global plugin-katalog (`~/.config/flashcode/plugins/`)
4. Prosjektpluginkatalog (`.flashcode/plugins/`)
