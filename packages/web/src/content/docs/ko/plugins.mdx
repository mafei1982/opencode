...
- `.flashcode/plugins/` - 프로젝트 레벨 플러그인
- `~/.config/flashcode/plugins/` - 글로벌 플러그인
...
**npm 플러그인**은 시작시 Bun을 사용하여 자동으로 설치됩니다. 패키지와 그 의존성은 `~/.cache/flashcode/node_modules/`에 캐시됩니다.
...
1. 글로벌 구성 (`~/.config/flashcode/flashcode.json`)
2. 프로젝트 구성 (`flashcode.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/flashcode/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.flashcode/plugins/`)
