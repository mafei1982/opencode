...
Questo è separato da `flashcode.json`, che configura il comportamento di server/runtime.
...
Usa `FLASHCODE_TUI_CONFIG` per caricare un path di configurazione TUI personalizzato.
