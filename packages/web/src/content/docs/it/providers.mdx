...
2. **Configura l'autenticazione** usando uno dei seguenti metodi:
   ...
   ***
   ...
   Per configurazione specifica del progetto o persistente, usa `flashcode.json`:
...
file `flashcode.json`. Si raccomanda anche di disabilitare la condivisione sessioni.
...
Personalizza tramite `flashcode.json`:
...
4. Crea o aggiorna il tuo file `flashcode.json` nella directory del progetto:
