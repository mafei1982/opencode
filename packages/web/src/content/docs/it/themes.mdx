...
2. **Directory di configurazione utente** - in `~/.config/flashcode/themes/*.json` o `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Directory root del progetto** - in `<project-root>/.flashcode/themes/*.json`
4. **Directory di lavoro corrente** - in `./.flashcode/themes/*.json`
