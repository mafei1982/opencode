...
:::caution
Quando usi `--hostname 0.0.0.0`, imposta `FLASHCODE_SERVER_PASSWORD` per proteggere il server.
...
- Configurazione e sessioni di OpenCode sono salvate nell'ambiente WSL in `~/.local/share/flashcode/`
