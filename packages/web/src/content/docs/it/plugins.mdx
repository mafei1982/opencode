...
- `.flashcode/plugins/` - plugin a livello progetto
- `~/.config/flashcode/plugins/` - plugin globali
...
I **plugin npm** vengono installati automaticamente usando Bun all'avvio. I pacchetti e le loro dipendenze vengono cache-ati in `~/.cache/flashcode/node_modules/`.
...
1. Config globale (`~/.config/flashcode/flashcode.json`)
2. Config di progetto (`flashcode.json`)
3. Directory plugin globale (`~/.config/flashcode/plugins/`)
4. Directory plugin di progetto (`.flashcode/plugins/`)
