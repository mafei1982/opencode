...
Utwórz `.flashcode/commands/test.md`:

```md title=".flashcode/commands/test.md"
---
...
Możesz zdefiniować polecenia w `flashcode.json` lub w plikach w katalogu `commands/`.
...
```json title="flashcode.jsonc" {4-12}
{
...
- Globalnie: `~/.config/flashcode/commands/`
- Na projekt: `.flashcode/commands/`

```markdown title="~/.config/flashcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".flashcode/commands/component.md"
---
...
```md title=".flashcode/commands/create-file.md"
---
...
```md title=".flashcode/commands/analyze-coverage.md"
---
...
```md title=".flashcode/commands/review-changes.md"
---
...
```md title=".flashcode/commands/review-component.md"
---
