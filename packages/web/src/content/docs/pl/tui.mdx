...
Jest to oddzielny plik od `flashcode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `FLASHCODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
