...
Ceci est séparé de `flashcode.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `FLASHCODE_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
