...
Configurez les agents dans votre fichier de configuration `flashcode.json` :
...
- Global : `~/.config/flashcode/agents/`
- Par projet : `.flashcode/agents/`

```markdown title="~/.config/flashcode/agents/review.md"
---
...
```json title="flashcode.json" {3-6,9-12}
{
  "$schema": "https://opencode.ai/config.json",
  "tools": {
    "write": true,
...
```json title="flashcode.json" {3-5,8-10}
{
  "$schema": "https://opencode.ai/config.json",
  "permission": {
    "edit": "deny"
...
```markdown title="~/.config/flashcode/agents/docs-writer.md"
---
...
```markdown title="~/.config/flashcode/agents/security-auditor.md"
---
