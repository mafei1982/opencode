...
- `.flashcode/plugins/` - Plugins au niveau du projet
- `~/.config/flashcode/plugins/` - Plugins globaux
...
Les **plugins npm** sont installés automatiquement à l'aide de Bun au démarrage. Les packages et leurs dépendances sont mis en cache dans `~/.cache/flashcode/node_modules/`.
...
1. Configuration globale (`~/.config/flashcode/flashcode.json`)
2. Configuration du projet (`flashcode.json`)
3. Répertoire global des plugins (`~/.config/flashcode/plugins/`)
4. Répertoire des plugins du projet (`.flashcode/plugins/`)
