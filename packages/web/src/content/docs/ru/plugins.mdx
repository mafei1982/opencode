...
- `.flashcode/plugins/` – плагины уровня проекта.
- `~/.config/flashcode/plugins/` — глобальные плагины
...
**Плагины npm** устанавливаются автоматически с помощью Bun при запуске. Пакеты и их зависимости кэшируются в `~/.cache/flashcode/node_modules/`.
...
1. Глобальная конфигурация (`~/.config/flashcode/flashcode.json`)
2. Конфигурация проекта (`flashcode.json`)
3. Глобальный каталог плагинов (`~/.config/flashcode/plugins/`)
4. Каталог плагинов проекта (`.flashcode/plugins/`)
