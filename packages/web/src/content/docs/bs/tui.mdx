...
Ovo je odvojeno od `flashcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `FLASHCODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
