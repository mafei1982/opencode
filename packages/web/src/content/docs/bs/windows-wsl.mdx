...
:::caution
Kada koristite `--hostname 0.0.0.0`, postavite `FLASHCODE_SERVER_PASSWORD` da zastitite server.
...
- Vase OpenCode konfiguracije i sesije cuvaju se u WSL okruzenju na `~/.local/share/flashcode/`
