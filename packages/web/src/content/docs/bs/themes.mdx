...
2. **Korisnicki config direktorij** - `~/.config/flashcode/themes/*.json` ili `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Korijenski direktorij projekta** - `<project-root>/.flashcode/themes/*.json`
4. **Trenutni radni direktorij** - `./.flashcode/themes/*.json`
