...
- Konfiguracija projekta: `.flashcode/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/flashcode/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.flashcode/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/flashcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.flashcode/skills/git-release/SKILL.md` ovako:
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `flashcode.json`:
...
**Za ugradene agente** (u `flashcode.json`):
