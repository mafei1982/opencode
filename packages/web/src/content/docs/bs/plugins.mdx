...
- `.flashcode/plugins/` - Dodaci na nivou projekta
- `~/.config/flashcode/plugins/` - Globalni dodaci
...
**npm dodaci** se instaliraju automatski pomoću Bun pri pokretanju. Paketi i njihove zavisnosti su keširani u `~/.cache/flashcode/node_modules/`.
...
1. Globalna konfiguracija (`~/.config/flashcode/flashcode.json`)
2. Konfiguracija projekta (`flashcode.json`)
3. Globalni direktorij dodataka (`~/.config/flashcode/plugins/`)
4. Direktorij dodataka projekta (`.flashcode/plugins/`)
