...
- `.flashcode/plugins/` - إضافات على مستوى المشروع
- `~/.config/flashcode/plugins/` - إضافات عامة
...
**إضافات npm** تُثبَّت تلقائيا باستخدام Bun عند بدء التشغيل. تُخزَّن الحزم واعتمادياتها مؤقتا في `~/.cache/flashcode/node_modules/`.
...
1. إعدادات عامة (`~/.config/flashcode/flashcode.json`)
2. إعدادات المشروع (`flashcode.json`)
3. دليل الإضافات العام (`~/.config/flashcode/plugins/`)
4. دليل إضافات المشروع (`.flashcode/plugins/`)
