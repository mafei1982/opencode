...
:::caution
When using `--hostname 0.0.0.0`, set `FLASHCODE_SERVER_PASSWORD` to secure the server.
:::
...
- Your OpenCode config and sessions are stored within the WSL environment at `~/.local/share/flashcode/`
