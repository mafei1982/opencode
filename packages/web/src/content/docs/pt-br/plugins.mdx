...
- `.flashcode/plugins/` - Plugins em nível de projeto
- `~/.config/flashcode/plugins/` - Plugins globais
...
**Plugins npm** são instalados automaticamente usando Bun na inicialização. Pacotes e suas dependências são armazenados em cache em `~/.cache/flashcode/node_modules/`.
...
1. Configuração global (`~/.config/flashcode/flashcode.json`)
2. Configuração do projeto (`flashcode.json`)
3. Diretório de plugins global (`~/.config/flashcode/plugins/`)
4. Diretório de plugins do projeto (`.flashcode/plugins/`)
