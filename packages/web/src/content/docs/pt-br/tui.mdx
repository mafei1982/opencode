...
Isso é separado do `flashcode.json`, que configura o comportamento do servidor/runtime.
...
Use `FLASHCODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
