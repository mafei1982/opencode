...
2. **Diretório de configuração do usuário** - Definido em `~/.config/flashcode/themes/*.json` ou `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Diretório raiz do projeto** - Definido em `<project-root>/.flashcode/themes/*.json`
4. **Diretório de trabalho atual** - Definido em `./.flashcode/themes/*.json`
