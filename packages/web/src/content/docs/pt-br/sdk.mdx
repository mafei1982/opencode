...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `flashcode.json`, mas você pode substituir ou adicionar configuração inline:
