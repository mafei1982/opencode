...
- `.flashcode/plugins/` – Plugins auf Projektebene
- `~/.config/flashcode/plugins/` – Globale Plugins
...
**NPM-Plugins** werden beim Start automatisch mit Bun installiert. Pakete und ihre Abhängigkeiten werden in `~/.cache/flashcode/node_modules/` zwischengespeichert.
...
1. Globale Konfiguration (`~/.config/flashcode/flashcode.json`)
2. Projektkonfiguration (`flashcode.json`)
3. Globales Plugin-Verzeichnis (`~/.config/flashcode/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.flashcode/plugins/`)
