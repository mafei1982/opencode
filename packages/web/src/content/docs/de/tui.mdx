...
Dies ist getrennt von `flashcode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `FLASHCODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
