...
:::caution
Wenn du `--hostname 0.0.0.0` verwendest, setze `FLASHCODE_SERVER_PASSWORD`, um den Server zu schuetzen.
...
- OpenCode-Konfiguration und Sitzungen liegen in WSL unter `~/.local/share/flashcode/`
