...
:::caution
Cuando uses `--hostname 0.0.0.0`, define `FLASHCODE_SERVER_PASSWORD` para proteger el servidor.
...
- Tu configuración y tus sesiones de OpenCode se guardan dentro del entorno WSL en `~/.local/share/flashcode/`
