...
2. **Directorio de configuración de usuario**: definido en `~/.config/flashcode/themes/*.json` o `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.flashcode/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.flashcode/themes/*.json`
