...
- Configuración del proyecto: `.flashcode/skills/<name>/SKILL.md`
- Configuración global: `~/.config/flashcode/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.flashcode/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/flashcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.flashcode/skills/git-release/SKILL.md` así:
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `flashcode.json`:
...
**Para agentes integrados** (en `flashcode.json`):
