...
Esto es independiente de `flashcode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `FLASHCODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
