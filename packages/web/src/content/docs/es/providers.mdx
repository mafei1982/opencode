...
2. **Configure la autenticación** utilizando uno de los siguientes métodos:
   ...
   Para una configuración persistente o específica del proyecto, utilice `flashcode.json`:
...
Archivo `flashcode.json`. También se recomienda desactivar el uso compartido de sesiones.
...
Personalizar a través de `flashcode.json`:
...
4. Cree o actualice su archivo `flashcode.json` en el directorio de su proyecto:
