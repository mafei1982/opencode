...
2. **Kullanıcı yapılandırma dizini** - `~/.config/flashcode/themes/*.json` veya `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Proje kök dizini** - `<project-root>/.flashcode/themes/*.json`
4. **Geçerli çalışma dizini** - `./.flashcode/themes/*.json`
