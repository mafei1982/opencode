...
- Proje konfigurasyonu: `.flashcode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/flashcode/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.flashcode/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/flashcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.flashcode/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`flashcode.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`flashcode.json` icinde):
