...
- `.flashcode/plugins/` - Proje düzeyinde eklentiler
- `~/.config/flashcode/plugins/` - Genel eklentiler
...
**npm eklentileri** başlangıçta Bun kullanılarak otomatik olarak yüklenir. Paketler ve bağımlılıkları `~/.cache/flashcode/node_modules/`'da önbelleğe alınır.
...
1. Global config (`~/.config/flashcode/flashcode.json`)
2. Project config (`flashcode.json`)
3. Global eklenti dizini (`~/.config/flashcode/plugins/`)
4. Proje eklenti dizini (`.flashcode/plugins/`)
