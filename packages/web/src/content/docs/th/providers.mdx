...
ใน `~/.local/share/flashcode/auth.json`.
...
2. **กำหนดค่าการตรวจสอบสิทธิ์** โดยใช้วิธีใดวิธีหนึ่งต่อไปนี้:
   ...
   สำหรับการกำหนดค่าเฉพาะโครงการหรือแบบถาวร ให้ใช้ `flashcode.json`:
...
`flashcode.json` ไฟล์. ขอแนะนำให้ปิดใช้งานการแชร์เซสชันด้วย
...
4. สร้างหรืออัปเดตไฟล์ `flashcode.json` ของคุณในไดเร็กทอรีโครงการของคุณ:
...
4. สร้างหรืออัปเดตไฟล์ `flashcode.json` ในไดเรกทอรีโครงการของคุณ:
