...
:::caution
เมื่อใช้ `--hostname 0.0.0.0` ให้ตั้งค่า `FLASHCODE_SERVER_PASSWORD` เพื่อป้องกันเซิร์ฟเวอร์
...
- การตั้งค่าและเซสชันของ OpenCode จะถูกเก็บในสภาพแวดล้อม WSL ที่ `~/.local/share/flashcode/`
