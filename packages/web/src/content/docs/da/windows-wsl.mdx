...
:::caution
Når du bruger `--hostname 0.0.0.0`, skal du sætte `FLASHCODE_SERVER_PASSWORD` for at sikre serveren.
...
- Din OpenCode-konfiguration og dine sessioner gemmes i WSL-miljøet i `~/.local/share/flashcode/`
