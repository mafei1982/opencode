...
- `.flashcode/plugins/` - Plugins på projektniveau
...
**npm plugins** installeres automatisk ved hjælp af Bun ved opstart. Pakker og deres afhængigheder cachelagres i `~/.cache/flashcode/node_modules/`.
...
1. Global konfiguration (`~/.config/flashcode/flashcode.json`)
2. Projektkonfiguration (`flashcode.json`)
3. Global plugin-mappe (`~/.config/flashcode/plugins/`)
4. Projekt plugin bibliotek (`.flashcode/plugins/`)
