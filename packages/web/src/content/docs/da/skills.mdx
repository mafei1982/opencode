...
- Prosjektkonfigurasjon: `.flashcode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/flashcode/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.flashcode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/flashcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.flashcode/skills/git-release/SKILL.md` slik:
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `flashcode.json`:
...
**For innebygde agenter** (i `flashcode.json`):
