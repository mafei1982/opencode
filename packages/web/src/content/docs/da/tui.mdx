...
Dette er adskilt fra `flashcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `FLASHCODE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
