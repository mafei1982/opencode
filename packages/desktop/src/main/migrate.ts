...
const TAURI_APP_IDS: Record<string, string> = {
  dev: "ai.flashcode.desktop.dev",
  beta: "ai.flashcode.desktop.beta",
  prod: "ai.flashcode.desktop",
}
function tauriAppId() {
  return app.isPackaged ? TAURI_APP_IDS[CHANNEL] : "ai.flashcode.desktop.dev"
}
