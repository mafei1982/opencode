export const dict = {
  ...
  "chat.empty.description": "Create a new session or select an existing one to begin chatting.",
  "settings.title": "Settings",
  "settings.providers": "Providers",
  "settings.models": "Models",
  "settings.providers.connected": "Connected Providers",
  "settings.providers.available": "Available Providers",
  "settings.providers.none": "No providers connected",
  ...
  "settings.models.none": "No models available",
